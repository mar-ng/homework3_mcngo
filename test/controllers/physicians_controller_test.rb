...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { physician_name: @physician.physician_name, physician_specialty: @physician.physician_specialty } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { physician_name: @physician.physician_name, physician_specialty: @physician.physician_specialty } }
