...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { office_phone: @office.office_phone, office_street_address: @office.office_street_address, office_zip: @office.office_zip } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { office_phone: @office.office_phone, office_street_address: @office.office_street_address, office_zip: @office.office_zip } }
