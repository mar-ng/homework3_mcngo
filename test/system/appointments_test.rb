...
class AppointmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Appointment" do
    ...
    fill_in "Appointment", with: @appointment.appointment_id
    fill_in "Patient name", with: @appointment.patient_name_id
    fill_in "Physician name", with: @appointment.physician_name_id
